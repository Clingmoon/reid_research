...
class MSMT17(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        ...
        self.list_train_path = osp.join(self.root, 'list_train.txt')
        self.list_val_path = osp.join(self.root, 'list_val.txt')
        self.list_query_path = osp.join(self.root, 'list_query.txt')
        self.list_gallery_path = osp.join(self.root, 'list_gallery.txt')
